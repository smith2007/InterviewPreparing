...
/*
    ...
    /**
     * конечно сначала приходит на ум -
     * отсортировать и потом применить тот предыдущий линейный алгоритм
     * создадим фантомный набор как бы того что нам не доставало до суммы
     * где ключ будет тот самый фантомный элемент,
     * а вот значение - это элемент в нашем массиве
     */

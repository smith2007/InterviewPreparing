...
public class IntervalListIntersections {
     ...
     *
     *
     * задача очень не сложная, надо только сосредоточится
     * на ней - решаем простым обходом через 2 указателя i и j первый указатель смотрит
     * на первый массив второй на второй
     * крутимся в цикле до тех пор пока не достигнем какого-либо конца
     * берем попарно элементы (они же отрезки как бы)
     * теперь наша задача попытаться найти как бы нижнюю границу нашего
     * теоретического отрезка - интерсекта нашего
     ...
     * а далее надо решить какой указатель двигать а как это понять??

...
public class ProductOfArrayExceptSelf {
    ...
    static int[] getProduct(int[] arr) {
        ...
        int temp = 1;
        //далее идем с конца, и перемножаем на temp элемент
        for (int i = arr.length - 1; i >= 0; i--) {
            phantom[i] = phantom[i] * temp;
            //тут фокус заключается в принципе обратной горки
            //так как массив отсортированный
            //мы каждый раз набиваем такой темп который при перемножении даст нам нужное число
            temp = temp * arr[i];
        }

...
public class TheSkylineProblem {
  ...
  /**
   *
   в общем мутная задача, много на нее времени тратить не хочу, в двух словах опишу
   как я понял - идея в том что мы на набиваем treeMap из наших как бы высот то есть сортированных по порядку что бы
   набить как бы чейн зданий образующий вот этот вот скайлайн как только добавляет новый как бы столб - а наше здание
   по факт образовано двумя столбами левым и правым у них есть координаты на оси x и на оси Y
   надо смотреть набивать tree map с такими высотами и от них как бы плясать

   по этому первый шаг это координаты нашего здания надо трансформировать в двойные координаты столбцов
   */

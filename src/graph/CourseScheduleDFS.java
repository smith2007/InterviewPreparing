...
public class CourseScheduleDFS {
	 ...
	 *
	 * а входе алгоритма у нас общее число курсов в виде числа и матрица зависимостей - по факту пар 0,1 - 2,3
	 ...
	 *
	 * в начале мы описываем нашу ноду, нашего графа, создаем статик класс Course, у которого в поле будет лист зависимостей - таких же крусов
	 *
	 * далее создаем эти курсы, просто в цикле фор сначала создаем пустые крусы
	 * второй шаг надо проставить зависимости - для этого берем пары из массива зависимостей - left и right
	 *
	 ...
	 * }
	 *
	 * ну и третий шаг мы раскручиваем цикл for, берем каждый отдельный крус и спрашиваем его а вот если мы начнем с тебя обход, даш ли ты нам начало цикла???? ну и передаем каждому на вход пустой массив visited - ов потому что так надо искать цикл / не цикл
	 * ну а как понять цикл / не цикл
	 *
	 * раскручиваем цикл по зависимостям от каждой ноды и ныряяем раскрашивая посещенные ноды, если нода из каких либо зависимостей оказалась уже раскрашена то все цикл есть - мы ее ранее посещали

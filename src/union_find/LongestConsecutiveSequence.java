...
public class LongestConsecutiveSequence {
  ...
  /**
   * решать будем через сета
   * это задача из разряда - гениальное просто
   *
   * нам надо всего лишь положить все наши элементы в сет
   * а затем траверсить нам массив - брать отправную точку как бы
   * и разбегаться в разные стороны с шагом 1 накручивая каунтер УДАЛЯЯЯ элементы из сета
   * все, и обновлять максимум
   */

...
public class Divided {
    ...
    public int divide(int dividend, int divisor) {
        ...
        /* нам необходимо сконвертировать оба числа в отрицательные
           так же мы будем считать кол-во отрицательных знаков
         */
        int negatives = 2;
        if (dividend > 0) {
            negatives--;
        ...
        /*
           в первом цикле мы просто нашли наибольший как бы двойник делителя который вписывается в делимое
           >= мы используем отрицательные
         */

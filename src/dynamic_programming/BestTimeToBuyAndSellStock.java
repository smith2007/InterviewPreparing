...
public class BestTimeToBuyAndSellStock {
     ...
     * решение: очень классный и простой алгоритм - решаем через DP - делаем массив,
     * делаем переменную min
...
//итерируем массив и спрашиваем каждый элемент массива
// - А ЕСЛИ ТЫ БУДЕШЬ МАКСИМУМОМ,  КАКОЙ ПРОФИТ МЫ СМОЖЕМ ПОЛУЧИТЬ НА ВЫХОДЕ?
// ОН ЛУЧШЕ ЧЕМ ТО ЧТО МЫ ПОЛУЧИЛИ НА ПРОШЛОМ ШАГЕ? - то есть тупо через минимум считаем
